...
Ein gedämpfter harmonischer Oszillator gnügt folgender Gleichung:
...
Wobei $A(\omega)$ die Fouriertransformierte von $f(t)$ ist. Unterstellt man eine Impulsanregung so kann
