...
if(!is.null(lfm_complete)){
  ...
  plot_title <- str_glue("{plot_title}
                         complete: f = {round(params_complete$estimate[2], 1)}, d = {round(params_complete$estimate[3], 1)}")
...
if(!is.null(lfm_bp)){
    ...
    plot_title <- str_glue("{plot_title}
                         bp:  f = {round(params_bp$estimate[2],1)}, d = {round(params_bp$estimate[3],1)}")
...
Zusammenfassung der (exemplarischen) Simulationsergebnisse:
