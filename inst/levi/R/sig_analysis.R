...
signalAnalysis <- function(input, output, session, tevi_model, sample_specs,
  ...
  c(signal_name, signal_brush) %<-%
    callModule(signal_ctrl, "completeTimerange", tevi_model, "radius_y", dynamicSidebarItems, selected_tab)
